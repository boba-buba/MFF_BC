...
public class Elevator {
        ...
        try {
            ...
            do {
                ...
                if (time != 0) {
                    from = readNum(st);
                    to = readNum(st);
                    events.add(new ButtonPress(time, from, to));
                }
            } while (time != 0);
        }
        catch (IOException e) {
    ...
    private void begin() {
        ...
        for (int i = 0; i < events.size(); ) {
            ButtonPress bp = (ButtonPress) events.get(i);
    ...
    public static void main(String args[]) {
        Elevator building = new Elevator("C:\\repositories\\nswi132\\du1\\elevator\\input\\data");
        building.begin();
