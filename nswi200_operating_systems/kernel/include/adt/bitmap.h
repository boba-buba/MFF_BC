...
/** How many bytes (as in sizeof()) are needed for bitmap of given length.
 *
 ...
 */
#define BITMAP_GET_STORAGE_SIZE(length) (((length) + (BITMAP_BITS_PER_UNIT - 1)) / BITMAP_BITS_PER_UNIT)
