 ...
 *
 * This test frees the memory in FIFO manner, i.e. smallest allocations
 * (at the end of the heap) are freed last. This test shall not pass
 * even by improved alternatives to bare bump-pointer implementation.
 */
