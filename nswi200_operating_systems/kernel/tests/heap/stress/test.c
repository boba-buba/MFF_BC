...
static unsigned int mem_blocks_accumulated_count;
...
static void init_mem(void) {
    mem_allocated = 0;
    mem_blocks_count = 0;
    mem_blocks_accumulated_count = 0;
...
void kernel_test(void) {
    ...
    ktest_assert(mem_blocks_accumulated_count > 0, "no allocation succeeded");
