...
#SBATCH --time=0:10:00 -N 4 -c 32 -p mpi-homo-short --mem 100G
...
# Example:
#
#   $ sbatch spark-slurm.sh /home/_teaching/para/04-spark/spark eno1 ~/sparkrw /mnt/1/spark/myapp.py 
#
# Spark configuration will be generated in ~/sparkrw/slurm-$SLURM_JOB_ID.spark; any
...
conf=${rwdir}/slurm-${SLURM_JOB_ID}.spark
...
srun --mem 32G sh -c "  ch-run -b '${conf}:/mnt/0' -b '${rwdir}:/mnt/1' -b '${tmpdir}:/mnt/2' '${img}' -- \
