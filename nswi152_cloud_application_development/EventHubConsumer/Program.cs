...
namespace EvetHubConsumer
{
    ...
    {
        private const string EventHubConnectionString = ""; // ie Endpoint=sb://CloudAppDev25EvH.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=XXX
        private const string EventHubName = ""; // ie myeventhub1
